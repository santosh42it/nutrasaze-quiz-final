...
export const ComponentByAnima = (): JSX.Element => {
                ...
                <Card className="h-[400px] md:h-[629px] border-0 overflow-hidden">
                  <CardContent className="p-0 h-full relative">
                    <div
                      ...
                      style={{
                        background: `linear-gradient(180deg, rgba(15,15,25,0) 0%, rgba(15,15,25,1) 100%), ${testimonial.backgroundImage} 50% 50% / cover`,
                      }}
                    >
                      <Button
                        variant="outline"
                        size="icon"
                        className="w-[60px] h-[60px] rounded-full bg-[#ebd5e5] backdrop-blur-sm border-0 shadow-shadow-primary-downward-base hover:bg-[#ebd5e5]"
                      >
